...
ndt2 = dddtree2('cplxdt',wimg,1,df{1},df{2});
b2=ndt2.cfs{1,2};
DLL1 = dct2(b2(:,:,1));
DHL1 = dct2(b2(:,:,2));
DLH1 = dct2(b2(:,:,3));
...
ndt3 = dddtree2('cplxdt',I1,1,df{1},df{2});
b3=ndt3.cfs{1,2};
...
ndt4 = dddtree2('cplxdt',I2,1,df{1},df{2});
b4=ndt4.cfs{1,2};
DLL1 = dct2(b4(:,:,1));
DHL1 = dct2(b4(:,:,2));
DLH1 = dct2(b4(:,:,3));
...
xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\psnr.xls',p,'E1:E10');
xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ssim.xls',s,'E1:E10');
xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\mse.xls',m,'E1:E10');
xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_int.xls',b,'I1:I10');
xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_int.xls',r,'J1:J10');
xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_binary.xls',b22,'I1:I10');
xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_binary.xls',r2,'J1:J10');
