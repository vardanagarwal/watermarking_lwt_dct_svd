...
DCV = dct2(CV);
DCD = dct2(CD);
DCHNUM=DCH(1:num,1:num);
DCVNUM=DCV(1:num,1:num);
DCDNUM=DCD(1:num,1:num);
...
DCV1 = dct2(CV1);
DCD1 = dct2(CD1);
DCH1NUM=DCH1(1:num,1:num);
DCV1NUM=DCV1(1:num,1:num);
DCD1NUM=DCD1(1:num,1:num);

%[UW0, SW0, VW0] = svd(DCA1);
[UW1, SW1, VW1] = svd(DCH1NUM);
[UW2, SW2, VW2] = svd(DCV1NUM);
[UW3, SW3, VW3] = svd(DCD1NUM);
...
[CDI1, CHI1, CVI1, CAI1] = lwt2(I2,'haar');
DCH1 = dct2(CHI1);
DCV1 = dct2(CVI1);
DCD1 = dct2(CDI1);
