...
[CD1, CH1, CV1, CA1] = lwt2(wimg,'haar');
%DCA1 = dct2(CA1);
DCH1 = dct2(CH1);
DCV1 = dct2(CV1);
DCD1 = dct2(CD1);
...
%I1_s0 = U1 * SC0 * V0';
I1_s1 = SC1*U1'+ repmat(V1,256,1);
I1_s2 = SC2*U2'+ repmat(V2,256,1);
I1_s3 = SC3*U3' +repmat(V3,256,1);
...
WaterMarked = ilwt2(I1_d3, I1_d1, I1_d2, CA, 'haar');
...
[CDO, CHO, CVO, CAO] = lwt2(WaterMarked,'haar');
%DCA = dct2(CAO);
DCHO = dct2(CHO);
DCVO = dct2(CVO);
DCDO = dct2(CDO);
...
[CDI1, CHI1, CVI1, CAI1] = lwt2(img,'haar');
DCH1 = dct2(CHI1);
DCV1 = dct2(CVI1);
DCD1 = dct2(CDI1);
...
int1=im2uint8(SC3);
int2=im2uint8(S33);
[bin2,rat2]=biterr(int1,int2);

I1_s11 = SR1*UW1'+repmat(VW1,256,1);
I1_s22 = SR2*UW2'+repmat(VW2,256,1);
I1_s33 = SR3*UW3'+repmat(VW3,256,1);

I1_d11 = idct2(I1_s11);
I1_d22 = idct2(I1_s22);
I1_d33 = idct2(I1_s33);

ExWaterMarked = ilwt2(I1_d33, I1_d11, I1_d22, CA1, 'haar');
...
% xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\psnr.xls',p,'C2:C11');
% xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ssim.xls',s,'C2:C11');
% xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\mse.xls',m,'C2:C11');
% xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_int.xls',b,'E2:E11');
% xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_int.xls',r,'F2:F11');
% xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_binary.xls',b2,'E2:E11');
% xlswrite('C:\Users\hp\Desktop\project on watermarking\excel_sheets\ber_binary.xls',r2,'F2:F11');
